...
class RobotArmEngine(object):
    ...
    def __init__(self,PORT):        
        print ("Initializing ROBOT_ARM_ENGNE ...")
        try:
    ...
    def goto(self, theta0_desired, theta1_desired, theta2_desired,theta3_desired):
        print("MK2 moving to:",theta0_desired, theta1_desired, theta2_desired,theta3_desired)
        try:
            ...
            print("Movement Failed since MK2 robot not connected properly")

        print(str(self.theta0) + "," + str(self.theta1) + "," + str(self.theta2) + "," + str(self.theta3))
        time.sleep(0.2)

    def single_base_movement(self,theta):
        try:
            self.set0(theta)
        except:
            print("Movement Failed since MK2 robot not connected properly")
